...
export class AddDestinationIdToActivity1745014048549
  implements MigrationInterface
{
  name = 'AddDestinationIdToActivity1745014048549';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cash_payment" DROP CONSTRAINT "cash_payment_payment_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "visa_payment" DROP CONSTRAINT "visa_payment_payment_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment" DROP CONSTRAINT "payment_invoice_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice" DROP CONSTRAINT "invoice_booking_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" DROP CONSTRAINT "booking_client_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" DROP CONSTRAINT "booking_yacht_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" DROP CONSTRAINT "booking_catering_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_activities" DROP CONSTRAINT "booking_activities_booking_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_activities" DROP CONSTRAINT "booking_activities_activity_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transport_request" DROP CONSTRAINT "transport_request_company_id_fkey"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feedback" DROP CONSTRAINT "feedback_rating_check"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment" DROP CONSTRAINT "payment_payment_type_check"`,
    );
    await queryRunner.query(`ALTER TABLE "yacht" ADD "destination_id" integer`);
    await queryRunner.query(
      `ALTER TABLE "activity" ADD "destination_id" integer`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "activity" DROP COLUMN "destination_id"`,
    );
    await queryRunner.query(`ALTER TABLE "yacht" DROP COLUMN "destination_id"`);
    await queryRunner.query(
      `ALTER TABLE "payment" ADD CONSTRAINT "payment_payment_type_check" CHECK (((payment_type)::text = ANY ((ARRAY['Cash'::character varying, 'Visa'::character varying])::text[])))`,
    );
    await queryRunner.query(
      `ALTER TABLE "feedback" ADD CONSTRAINT "feedback_rating_check" CHECK (((rating >= 1) AND (rating <= 5)))`,
    );
    await queryRunner.query(
      `ALTER TABLE "transport_request" ADD CONSTRAINT "transport_request_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "transport_company"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_activities" ADD CONSTRAINT "booking_activities_activity_id_fkey" FOREIGN KEY ("activity_id") REFERENCES "activity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_activities" ADD CONSTRAINT "booking_activities_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "booking"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" ADD CONSTRAINT "booking_catering_id_fkey" FOREIGN KEY ("catering_id") REFERENCES "catering"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" ADD CONSTRAINT "booking_yacht_id_fkey" FOREIGN KEY ("yacht_id") REFERENCES "yacht"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking" ADD CONSTRAINT "booking_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "client_profile"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD CONSTRAINT "invoice_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "booking"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "visa_payment" ADD CONSTRAINT "visa_payment_payment_id_fkey" FOREIGN KEY ("payment_id") REFERENCES "payment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cash_payment" ADD CONSTRAINT "cash_payment_payment_id_fkey" FOREIGN KEY ("payment_id") REFERENCES "payment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "feedback" ADD CONSTRAINT "feedback_booking_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "booking"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "feedback" ADD CONSTRAINT "feedback_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "client_profile"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "client_phones" ADD CONSTRAINT "client_phones_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "client_profile"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
